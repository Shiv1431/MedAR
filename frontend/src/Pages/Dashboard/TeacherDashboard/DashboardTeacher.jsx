...
function DashboardTeacher() {
  ...
  useEffect(() => {
    const getData = async () => {
      try {
        const response = await fetch(`http://localhost:8000/api/Teacher/TeacherDocument/${ID}`, {
          method: "GET",
          credentials: "include",
          headers: {
  ...
  useEffect(() => {
    const getAmount = async () => {
      try {
        const response = await fetch(`http://localhost:8000/api/payment/teacher/${ID}/balance`, {
          method: "POST",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    const getCourses = async () => {
      try {
        const response = await fetch(`http://localhost:8000/api/course/Teacher/${ID}/enrolled`, {
          method: "GET",
          credentials: "include",
          headers: {
            "Content-Type": "application/json",
